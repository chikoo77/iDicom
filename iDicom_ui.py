...
# Form implementation generated from reading ui file 'iDicom.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Axial", None))
        self.label_3.setText(_translate("Form", "Coronal", None))
        self.label_2.setText(_translate("Form", "Sagital", None))
